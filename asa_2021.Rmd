...
* The 20% quantile of median household income was selected as a threshold to identify disadvantaged communities based on the CA HUD [low income guidelines][3.00] which indicates a similar metric.
...
* NHCS COVID-19 [mortality count data][3.00] reported by county was used to measure the impact of the pandemic on communities within California.
