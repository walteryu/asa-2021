...
* Name: Walter Yu
* Organization: Code for America ([Sacramento Brigade][00.13])
* Source Code: Github [Repository][00.14]

[00.00]: https://community.amstat.org/dataexpo/home
[00.13]: https://codeforsacramento.org/
[00.14]: https://github.com/walteryu/asa-2021
...
2. Data Processing: Data prepration for analysis
...
> Race has a good relationship with median household income as verified with the model fit and low p-value. In particular, residents which indicated "American Indian", "Alaska Native alone" and "Asian alone" as their race were more closely associated with median household income.
...
> Poverty level has a good relationship with median household income as verified with the model fit and low p-value. However when either of the two features are isolated, then their fit is poor so poverty is not particularly useful for the analysis.
